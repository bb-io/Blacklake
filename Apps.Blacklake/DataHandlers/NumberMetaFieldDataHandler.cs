...
public class NumberMetaFieldDataHandler(InvocationContext invocationContext, [ActionParameter] LakeInput lakeInput) : BlacklakeInvocable(invocationContext), IAsyncDataSourceItemHandler
{
